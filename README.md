...
Then click this for frontend view: https://frontend-nine-sepia-71.vercel.app. Please go in that order(by clicking backend link, then frontend link). After that, you can have fun testing the project. (Make sure the backend is not idle)
